...
> = {
  ...
  ja: {
    "airpods-5": {
      name: "AirPods 5", eyebrow: "オープンイヤー。音の世界もオープンに。", intro: "オープンイヤー型で最高クラスのアクティブノイズキャンセリング、進化したサウンド、Siri AI、ライブ翻訳を手頃なAirPodsに。", display: "オープンイヤー", primarySpecLabel: "フィット", camera: "最大50%向上", secondarySpecLabel: "ANC", battery: "ANCで4〜5時間", designTitle: "一日中快適。もっと頼もしく。", designBody: "洗練されたオープンイヤー形状が快適にフィットし、防塵・耐汗・耐水性能も向上しました。", cameraTitle: "オープンイヤーANCが飛躍。", cameraBody: "高度なコンピュテーショナルオーディオがAirPods 4のANC搭載モデルより最大50%多く周囲の騒音を除去し、外部音取り込みも自然です。", secondarySectionKicker: "オーディオ / 02", performanceTitle: "新しい音響アーキテクチャ。", performanceBody: "マルチポート音響設計と次世代Adaptive EQが没入感を高め、Siri AIとライブ翻訳にも対応します。",
    },
    "airpods-pro-3": {
